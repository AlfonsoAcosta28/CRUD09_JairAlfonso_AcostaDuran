        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DestinationIdId = table.Column<int>(type: "int", nullable: false),
                    OriginIdId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Journeys_Cities_DestinationIdId",
                        column: x => x.DestinationIdId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Journeys_Cities_OriginIdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Journeys_DestinationIdId",
                table: "Journeys",
                column: "DestinationIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Journeys_OriginIdId",
                table: "Journeys",
                column: "OriginIdId");
